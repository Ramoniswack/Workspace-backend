 ...
 */
const getSpaceMembers = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    ...
    const members = workspace.members.map((member: any) => {
      const override = spaceMembers.find(
        (sm: any) => sm.user._id.toString() === member.user._id.toString()
      );
 ...
 */
const addSpaceMember = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    const { spaceId } = req.params;
 ...
 * @access  Private (Admin or Owner)
 */
const updateSpaceMember = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
 ...
 * @access  Private (Admin or Owner)
 */
const removeSpaceMember = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    const { spaceId, userId } = req.params;
