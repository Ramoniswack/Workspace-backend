...
// @access  Private
const getList = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const updateList = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { name } = req.body;
...
// @access  Private
const deleteList = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
