...
// @access  Private
const getListTasks = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { listId } = req.params;
...
// @access  Private
const getTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const deleteTask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const createSubtask = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { title, description, priority, dueDate, assignee } = req.body;
...
// @access  Private
const getSubtasks = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { taskId } = req.params;
...
// @access  Private
const addDependency = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { taskId } = req.params;
...
// @access  Private
const removeDependency = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const getDependencies = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { taskId } = req.params;
...
// @access  Private
const getDependents = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { taskId } = req.params;
