 ...
 * @access  Private
 */
const registerDevice = asyncHandler(async (req: any, res: any) => {
 ...
 * @access  Private
 */
const unregisterDevice = asyncHandler(async (req: any, res: any) => {
 ...
 * @access  Private
 */
const getDevices = asyncHandler(async (req: any, res: any) => {
  const userId = req.user.id;
