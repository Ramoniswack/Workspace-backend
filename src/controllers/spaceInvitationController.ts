 ...
 */
const sendSpaceInvitation = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    ...
    if (user) {
      ...
      if (!isWorkspaceMember) {
        return next(
          new AppError("User must be a workspace member first. Please invite them to the workspace.", 400)
        );
      }
 ...
 * @access  Private (Admin or Owner)
 */
const getSpaceInvitations = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    const { spaceId } = req.params;
 ...
 * @access  Private
 */
const acceptSpaceInvitation = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
 ...
 * @access  Private
 */
const declineSpaceInvitation = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    const { token } = req.params;
    const userId = req.user!.id;
 ...
 * @access  Private (Admin or Owner)
 */
const cancelSpaceInvitation = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
 ...
 * @access  Private
 */
const getMySpaceInvitations = asyncHandler(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    const userId = req.user!.id;
