...
// @access  Private
const createSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const getWorkspaceSpaces = asyncHandler(async (req, res, next) => {
    const { workspaceId } = req.params;
...
// @access  Private
const getSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const updateSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const deleteSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const addMemberToSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const removeMemberFromSpace = asyncHandler(async (req, res, next) => {
...
// @access  Private
const inviteExternalUsers = asyncHandler(async (req, res, next) => {
