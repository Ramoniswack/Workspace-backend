 ...
 */
router.get("/workspaces/:workspaceId/summary", analyticsController.getWorkspaceOverview);
/**
 * @swagger
 ...
 *         description: Workspace not found
 */
router.get("/workspaces/:workspaceId/workload", analyticsController.getTeamWorkload);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/lead-time", analyticsController.getLeadTime);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/burn-down", analyticsController.getBurnDown);
/**
 * @swagger
